    ...
    public List<SprintGetResponseDto> getSprints() throws AgileSysException {
        ...
        if (sprints != null) {
            for (Sprint sprint : sprints) {
                ...
                sprintGetResponseDto.setHistoriasUsuario(historiaUsuarioBean.getHistoriaUsuarioProyectoAndSprint(
                ...
                if (sprint.getIniciado() != null)
                    sprintGetResponseDto.setIniciado(sprint.getIniciado());
                else
                    sprintGetResponseDto.setIniciado(false);

            ...
            for (Usuario usuario : usuarios) {
                if (usuario.getEstado()) {
                    ...
                    if (usuario.getIdRol() == null)
                        ...
                        usuarioResponseDto.setRol(
                                new RolDto(usuario.getIdRol().getIdRol(), usuario.getIdRol().getDescripcionRol()));
                    usuarioResponseDto.setTelefono(usuario.getTelefono());
                    UsuarioProyecto usuarioProyecto = usuarioProyectoDao
                            .findProyectoIniciadoByIdUsuario(usuario.getIdUsuario());
                    if (usuarioProyecto != null)
                        usuarioResponseDto.setIdProyecto(usuarioProyecto.getIdProyecto().getIdProyecto());
                    else
                        usuarioResponseDto.setIdProyecto(0);
